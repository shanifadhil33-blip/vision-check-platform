...
-- Git record (never executed): supabase/migrations/20260922120000_vcp_privileges_tidy.sql
-- Version: 20260922120000_vcp_privileges_tidy
-- Privilege statements are identical to the git record. Tracking insert is in
...
-- Tracking registration (apply copy only). Same transaction as the privilege changes.
insert into vcp.schema_migrations (version)
  values ('20260922120000_vcp_privileges_tidy');
