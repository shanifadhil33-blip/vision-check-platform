-- EMERGENCY ONLY. THIS SCRIPT RESTORES THE PREVIOUS BROKEN FUNCTION BODIES
-- AND DELETES ONLY THE TRACKING ROW FOR 20260908160000_vcp_rpc_coalesce_fix.
-- IT DOES NOT DROP THE TEN public.vcp_* RPCs. DROPPING THEM WOULD LEAVE THE
-- APPLIED 20260908140000_vcp_rpc_surface SURFACE INCOMPLETE.
-- ROLLING BACK RESTORES FUNCTIONS THAT RAISE 42883 AT RUNTIME
-- (function pg_catalog.coalesce(...) does not exist). THIS EXISTS ONLY TO
...
-- ---------------------------------------------------------------------------
-- Restore broken bodies from 20260908140000_vcp_rpc_surface verbatim.
-- ---------------------------------------------------------------------------
...
where version = '20260908160000_vcp_rpc_coalesce_fix';
