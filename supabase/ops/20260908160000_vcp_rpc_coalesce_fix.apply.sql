...
-- Git record (never executed): supabase/migrations/20260908160000_vcp_rpc_coalesce_fix.sql
-- Version: 20260908160000_vcp_rpc_coalesce_fix
-- Function bodies are identical to the git record. Tracking insert is in
...
-- Tracking registration (apply copy only). Same transaction as the function bodies.
insert into vcp.schema_migrations (version)
  values ('20260908160000_vcp_rpc_coalesce_fix');
